...
def preprocess(args, input_folders, out_dir, hparams):
    ...
    metadata = preprocessor.build_from_path_v1(hparams, input_folders, out_dir, args.n_jobs, tqdm=tqdm)
...
def run_preprocess(args, hparams):
    ...
    output_folder = os.path.join(args.base_dir, args.dataset, args.output)
...
def main():
    ...
    parser.add_argument('--output', default=hparams.feat_out_dir) #'training_data')
    parser.add_argument('--n_jobs', type=int, default=cpu_count() * 2)
