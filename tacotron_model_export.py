...
cwd = os.getcwd()
checkpoint_path = os.path.join(cwd, 'logs-Tacotron-2/taco_pretrained/tacotron_model.ckpt-207000')
#tacotron_model.ckpt-181000.meta
sess = tf.Session()
sess.run(tf.global_variables_initializer())
saver = tf.train.Saver()
saver.restore(sess, checkpoint_path)

export_path_base = os.path.join(cwd, 'export')
