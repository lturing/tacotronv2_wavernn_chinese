...
if __name__ == '__main__':
    ...
    checkpoint_path = os.path.join(cwd, './logs-Tacotron-2/taco_pretrained/tacotron_model.ckpt-206500')
    ...
    #text = '中共中央总书记国家主席中央军委主席习近平4月8日给武汉市东湖新城社区全体社区工作者回信，再次肯定城乡广大社区工作者在疫情防控斗争中发挥的重要作用。'
