...
from tacotron.models.attention import GMMAttention
...
class Tacotron():
    ...
    def initialize(self, inputs, input_lengths, mel_targets=None, stop_token_targets=None, linear_targets=None, targets_lengths=None, gta=False,
        ...
        with tf.variable_scope('inference') as scope:
            ...
            #Attention Mechanism
            attention_mechanism = GMMAttention(self.encoder_outputs, input_lengths, is_training)
    ...
    def add_optimizer(self, global_step):
        ...
        with tf.variable_scope('optimizer') as scope:
            ...
            gradients, variables = zip(*optimizer.compute_gradients(self.loss, var_list=self.all_vars))
